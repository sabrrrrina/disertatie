const keywordMap = {
    violence: [
        ...
        "execution", "torture", "rape", "homicide", "war", "combat", "beheading", "school shooting"
    ],
    hate: [
...
//asta pt img, revin la ea mai incolo
function scanPage(blockrules) {
    const allTextElements = document.querySelectorAll("p, h1, h2, h3, span, a, div");
    const allMedia = document.querySelectorAll("img, video, figure, figcaption");
    ...
    categories.forEach(cat => {
        if (blockrules[cat]) {
            ...
            [...allTextElements, ...allMedia].forEach(el => {
